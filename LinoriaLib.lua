if CoreGui:FindFirstChild("solitution") then
    CoreGui.solitution:Destroy()
end
...
local Library = {
    ...
    AccentColor = Color3.fromRGB(98, 92, 115);
    OutlineColor = Color3.fromRGB(42, 41, 47);
