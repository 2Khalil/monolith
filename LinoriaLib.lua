...
local Library = {
    ...
    FontColor = Color3.fromRGB(228,228,228);
    MainColor = Color3.fromRGB(18, 18, 29);
    BackgroundColor = Color3.fromRGB(20, 19, 31);
    AccentColor = Color3.fromRGB(231, 123, 249);
    OutlineColor = Color3.fromRGB(37, 38, 62);
